...
namespace Exp
{
    ...
    public partial class Compiler : IVarSystem
    {
        ...
        private Variable SetVar(string name, object value, WordSpan settingVar = null, IVarSystem specificVS = null, bool createConst = false)
        {
            ...
            {
                v = new Variable(name, value, settingVar, cons: createConst);
                (specificVS ?? CurrentVarSystem).Vars.Add(v);
            }
            return v;
        }
